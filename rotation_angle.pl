...
$divider2->size     = {x => 1.5};
$divider2->range    = {x => [60, 160], y => [0.005,1]};
$divider2->where    = qq{rotation_angle IN (7000,8000,9000,10000,11000,12000,13000,14000) and relaxation_time > 0.005 AND date NOT IN ('2009-01-26', '2009-01-27', '2009-01-28', '2009-01-29', '2009-02-10', '2009-02-17')};
$divider2->run;
